...
# Mapeamento Refletindo o Novo Estado: Compactado por Ano + 6 Núcleos (Força Máxima)
QUERIES = {
    "Bench_1_Serie_Temporal_CompactYear_6Cores": """
    ...
    """,
    "Bench_2_Alta_Cardinalidade_CompactYear_6Cores": """
    ...
    """,
    "Bench_3_Filtros_Complexos_CompactYear_6Cores": """
    ...
    """,
    "BI_1_ONS_Infraestrutura_CompactYear_6Cores": """
    ...
    """,
    "BI_2_FUNAI_Terras_Indigenas_CompactYear_6Cores": """
    ...
    """,
    "BI_3_Defesa_Civil_Risco_CompactYear_6Cores": """
...
def main():
    print("="*80)
    print(" ⚡ BENCHMARK FINAL (FASE 3): DADOS COMPACTADOS (ANO) + 6 NÚCLEOS ⚡")
    print("="*80)
    ...
    metric_file = f"{output_dir}/relatorio_estatistico_CompactYear_6Cores.csv"
