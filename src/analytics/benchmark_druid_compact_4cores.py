...
# Mapeamento Refletindo o Novo Estado: Compactado por Ano + 4 Núcleos
QUERIES = {
    "Bench_1_Serie_Temporal_CompactYear_4Cores": """
    ...
    """,
    "Bench_2_Alta_Cardinalidade_CompactYear_4Cores": """
    ...
    """,
    "Bench_3_Filtros_Complexos_CompactYear_4Cores": """
    ...
    """,
    "BI_1_ONS_Infraestrutura_CompactYear_4Cores": """
    ...
    """,
    "BI_2_FUNAI_Terras_Indigenas_CompactYear_4Cores": """
    ...
    """,
    "BI_3_Defesa_Civil_Risco_CompactYear_4Cores": """
...
def main():
    print("="*80)
    print(" ⚡ BENCHMARK FINAL (FASE 2): DADOS COMPACTADOS (ANO) + 4 NÚCLEOS ⚡")
    print("="*80)
    ...
    metric_file = f"{output_dir}/relatorio_estatistico_CompactYear_4Cores.csv"
