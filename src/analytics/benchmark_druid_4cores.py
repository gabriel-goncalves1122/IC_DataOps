...
# Mapeamento com Nomes Refletindo o Estado: 6.518 Segmentos + 4 Núcleos
QUERIES = {
    "Bench_1_Serie_Temporal_6518Seg_4Cores": """
        SELECT 
        ...
        LIMIT 100
    """,
    "Bench_2_Alta_Cardinalidade_6518Seg_4Cores": """
        SELECT 
          municipio, 
          bioma, 
        ...
        LIMIT 50
    """,
    "Bench_3_Filtros_Complexos_6518Seg_4Cores": """
        SELECT 
          satelite,
        ...
        GROUP BY 1
    """,
    "BI_1_ONS_Infraestrutura_6518Seg_4Cores": """
        SELECT 
          linha_afetada, 
          estado,
        ...
        LIMIT 15
    """,
    "BI_2_FUNAI_Terras_Indigenas_6518Seg_4Cores": """
        SELECT 
          nome_ti, 
          estado, 
          bioma, 
        ...
        LIMIT 10
    """,
    "BI_3_Defesa_Civil_Risco_6518Seg_4Cores": """
        SELECT 
          estado, 
          risco_eletrico, 
...
def main():
    print("="*80)
    print(" ⚡ BENCHMARK: DADOS FRAGMENTADOS (6.518 SEGMENTOS) + CPU INTERMEDIÁRIA (4 NÚCLEOS) ⚡")
    print("="*80)
    ...
    metric_file = f"{output_dir}/relatorio_estatistico_6518Seg_4Cores.csv"
